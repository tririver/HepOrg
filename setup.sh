...
echo "  and the pdf file is saved to $LOCALDIR/pdf/Maldacena_astro-ph_0210603.pdf"
...
echo ""
echo "The output message is as follows, which is also in $LOCALDIR/events.log"
echo ""
